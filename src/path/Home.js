        ...
        <div className='container'>
          <div className='d-flex justify-content-between'>
            ...
            <div className='d-flex flex-column justify-content-center'>
              <h4 className='text-end' id='title'>NEW ARRIVALS</h4>
              <h1 className='text-end' id='title'>new <br /> collections <br /> for everyone</h1>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className='container'>
          <div className='d-flex'>
            <div className='text d-flex flex-column justify-content-center w-75'>
              ...
              <Button id='Btn' href='/shop' className='mt-4'>Exclusive Offers <i className="bi bi-arrow-right"></i></Button>
            </div>
            <div className='img'>
